...
public class Laser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        positions[0] = transform.position;// set first point to orgin of ball
        positions[1] = new Vector3(0.0f, 0f, 0.0f); // temporary pos, this pos is chanded 
